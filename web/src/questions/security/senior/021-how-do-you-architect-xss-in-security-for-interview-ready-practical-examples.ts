...
export const question = "How do you architect xss in SECURITY for interview-ready practical examples?" as const;
export const tags = ["security","senior","xss"] as const;
