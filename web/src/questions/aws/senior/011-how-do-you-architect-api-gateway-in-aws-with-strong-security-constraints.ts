...
export const question = "How do you architect api gateway in AWS with strong security constraints?" as const;
export const tags = ["aws","senior","api-gateway","security"] as const;
