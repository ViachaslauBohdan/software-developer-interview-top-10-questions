...
export const question = "How do you implement api gateway in AWS for interview-ready practical examples?" as const;
export const tags = ["aws","middle","api-gateway"] as const;
