...
export const question = "How do you architect guards in NEST with strong security constraints?" as const;
export const tags = ["nest","senior","guards","security"] as const;
