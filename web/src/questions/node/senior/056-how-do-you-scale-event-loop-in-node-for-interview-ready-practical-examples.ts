...
export const question = "How do you scale event loop in NODE for interview-ready practical examples?" as const;
export const tags = ["node","senior","event-loop"] as const;
