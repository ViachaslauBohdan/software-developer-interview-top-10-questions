...
export const question = "How do you architect streams in NODE for interview-ready practical examples?" as const;
export const tags = ["node","senior","streams"] as const;
