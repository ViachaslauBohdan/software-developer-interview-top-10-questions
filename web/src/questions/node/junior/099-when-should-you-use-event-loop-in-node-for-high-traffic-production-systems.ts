...
export const question = "When should you use event loop in NODE for high-traffic production systems?" as const;
export const tags = ["node","junior","event-loop"] as const;
