...
export const question = "What is accessibility in CSS with strong security constraints?" as const;
export const tags = ["css","junior","accessibility","security"] as const;
