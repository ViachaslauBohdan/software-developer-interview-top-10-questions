...
export const question = "What is design tokens in CSS with strong security constraints?" as const;
export const tags = ["css","junior","design-tokens","security"] as const;
