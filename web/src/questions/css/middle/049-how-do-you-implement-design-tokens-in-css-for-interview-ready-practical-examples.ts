...
export const question = "How do you implement design tokens in CSS for interview-ready practical examples?" as const;
export const tags = ["css","middle","design-tokens"] as const;
