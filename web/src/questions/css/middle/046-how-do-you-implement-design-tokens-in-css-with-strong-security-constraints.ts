...
export const question = "How do you implement design tokens in CSS with strong security constraints?" as const;
export const tags = ["css","middle","design-tokens","security"] as const;
