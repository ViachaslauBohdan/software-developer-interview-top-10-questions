...
export const question = "How do you architect specificity in CSS for interview-ready practical examples?" as const;
export const tags = ["css","senior","specificity"] as const;
