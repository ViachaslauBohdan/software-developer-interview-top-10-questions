...
export const question = "How do you architect design tokens in CSS with strong security constraints?" as const;
export const tags = ["css","senior","design-tokens","security"] as const;
