...
export const question = "How do you architect performance in CSS with strong security constraints?" as const;
export const tags = ["css","senior","performance","security"] as const;
