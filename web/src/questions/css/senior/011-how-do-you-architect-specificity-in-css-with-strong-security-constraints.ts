...
export const question = "How do you architect specificity in CSS with strong security constraints?" as const;
export const tags = ["css","senior","specificity","security"] as const;
