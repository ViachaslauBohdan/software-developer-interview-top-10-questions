...
export function answer(): string {
  return "For \"How do you design a fault-tolerant Node.js backend for high load\", give a clear definition, outline key trade-offs, and finish with one practical production-ready pattern.";
}
