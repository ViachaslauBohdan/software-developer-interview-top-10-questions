...
export function answer(): string {
  return "For \"How do you enforce backend engineering standards and code quality\", give a clear definition, outline key trade-offs, and finish with one practical production-ready pattern.";
}
