...
export function answer(): string {
  return "For \"How do you approach API contract governance across multiple teams\", give a clear definition, outline key trade-offs, and finish with one practical production-ready pattern.";
}
