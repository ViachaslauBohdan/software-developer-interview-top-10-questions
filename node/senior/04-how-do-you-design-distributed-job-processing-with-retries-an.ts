...
export function answer(): string {
  return "For \"How do you design distributed job processing with retries and deduplication\", give a clear definition, outline key trade-offs, and finish with one practical production-ready pattern.";
}
